...
public class Tnt0Block extends TntBlock {
    public static final MapCodec<Tnt0Block> CODEC = simpleCodec(Tnt0Block::new);

    public Tnt0Block(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    private static void prime(Level level, BlockPos pos, @Nullable LivingEntity igniter, int fuse) {
        ...
        Tnt0PrimedEntity primed = new Tnt0PrimedEntity(level, pos, igniter);
        primed.setFuse(fuse);
